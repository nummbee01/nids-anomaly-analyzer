...
def test_convert_bytes_to_mac():
    assert convert_bytes_to_mac(b"\x01\x02\x03\x04\x05\x06") == "01:02:03:04:05:06"


def test_convert_bytes_to_ipv4():
    assert convert_bytes_to_ipv4(b"\x7f\x00\x00\x01") == "127.0.0.1"


def test_convert_bytes_to_ipv6():
    ...
    assert convert_bytes_to_ipv6(ip6_bytes) == expected
...
if __name__ == "__main__":
    test_convert_bytes_to_mac()
    test_convert_bytes_to_ipv4()
    test_convert_bytes_to_ipv6()
    test_parse_ethernet()
    test_parse_ipv4()
    test_parse_ipv6()
    test_parse_tcp()
